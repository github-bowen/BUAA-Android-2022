...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        FriendShipDao.createTable(db, ifNotExists);
        KnowledgeDao.createTable(db, ifNotExists);
        KnowledgeBlankDao.createTable(db, ifNotExists);
        KnowledgeHistoryDao.createTable(db, ifNotExists);
        ...
        WordTaskDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        FriendShipDao.dropTable(db, ifExists);
        KnowledgeDao.dropTable(db, ifExists);
        KnowledgeBlankDao.dropTable(db, ifExists);
        KnowledgeHistoryDao.dropTable(db, ifExists);
        ...
        WordTaskDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(FriendShipDao.class);
        registerDaoClass(KnowledgeDao.class);
        registerDaoClass(KnowledgeBlankDao.class);
        registerDaoClass(KnowledgeHistoryDao.class);
        ...
        registerDaoClass(WordTaskDao.class);
    }
